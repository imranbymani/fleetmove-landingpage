    ...
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        <div className="space-y-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-50 text-indigo-600 text-xs font-bold uppercase tracking-wider">
          ...
          <div className="flex flex-col sm:flex-row gap-5">
            <button className="group flex items-center justify-center gap-3 bg-indigo-600 text-white px-10 py-5 rounded-2xl font-extrabold hover:bg-indigo-700 transition-all shadow-2xl shadow-indigo-200">
              Download Now
              <ArrowRight className="w-6 h-6 group-hover:translate-x-1 transition-transform" />
            </button>
            <button className="flex items-center justify-center gap-3 px-10 py-5 rounded-2xl font-extrabold border-2 border-gray-100 hover:border-indigo-100 hover:bg-indigo-50 transition-all">
          ...
          <div className="flex items-center gap-12 pt-6">
            <div>
              <p className="text-4xl font-extrabold text-gray-900">10M+</p>
              <p className="text-sm font-bold text-gray-400 mt-1 uppercase tracking-widest">Users</p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm font-bold text-gray-400 mt-1 uppercase tracking-widest">Reviews</p>
            </div>
          </div>
        </div>
          ...
          <div className="absolute -bottom-6 -left-10 bg-white p-6 rounded-3xl shadow-2xl z-20 border border-gray-100 float">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xl font-black text-gray-900">4 Minutes</p>
              </div>
            </div>
          </div>
        </div>
