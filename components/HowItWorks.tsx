    ...
    <section id="how-it-works" className="py-24 bg-white relative">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center space-y-4 mb-20">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-gray-900">Simple steps to ride</h2>
          <p className="text-gray-500 max-w-xl mx-auto text-lg font-medium">We've streamlined urban mobility so you can focus on where you're going, not how to get there.</p>
        </div>
          ...
          {steps.map((step, idx) => (
            <div key={idx} className="relative group">
              ...
              <div className="space-y-6">
                <div className={`w-16 h-16 ${step.color} rounded-2xl flex items-center justify-center shadow-sm`}>
                  {step.icon}
                </div>
